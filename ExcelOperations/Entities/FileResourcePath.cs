...
//        {
//            { "RouterAktuell", $@"{RootPath}Aktuell\Router_aktuell.xlsx" },
//            { "XWDMAktuell", $@"{RootPath}Aktuell\xWDM_aktuell.xlsx,XWDMAktuell" },
//            { "LagerCentral", $@"{RootPath}Lagers\Lager Central 2023-02-23.xlsm,LagerCentral"},
//            { "Cisco_PO", $@"{RootPath}PO\Project 2023-02-17.xlsx,Cisco_PO"},
//            { "Deltatel_PO", $@"{RootPath}PO\Deltatel_PO.xlsx,Deltatel_PO" },
//            { "ZTE_PO", $@"{RootPath}PO\DWM_Projeckt_2023-02-18.xlsx,ZTE_PO" },
//            { "JSLMultiProject",$@"{RootPath}POC\POC_JSL_Multiprojekt_2.0_aktuell.xlsx,JSLMultiProject" },
//            { "MultiProject",$@"{RootPath}POC\POC_Multiprojekt_2.0_aktuell.xlsx,MultiProject" },
//            { "RouterSwapAktuell", $@"{RootPath}Aktuell\ROUTER_Swap_aktuell.xlsm,RouterSwapAktuell" },
//            { "ZugangsdatenAktuell",$@"{RootPath}Zugang\Zugangsdaten_aktuell.xlsx,ZugangsdatenAktuell" },
//            { "RouterAktuelOrderList", $@"{RootPath}Aktuell\Router_aktuell.xlsx,RouterAktuellOrderList" },
//            { "XWDMAktuellOrderList", $@"{RootPath}Aktuell\xWDM_aktuell.xlsx,XWDMAktuellOrderList" }
//        };
...
//public (string, int) MatchLocation(string loc)
//{
//    var fileName = Paths.ContainsKey(loc);
